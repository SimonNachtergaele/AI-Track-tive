...
while var_manually_review.get()==1 and shutdown_script == 0 and annotate.get()==0:
    ...
    # Start here if it's an apatite/ed couple or only apatite (LAFT)
        ...
        for apatite_paths in list_of_lists_ap: 
            ...
            if width == height:
                print('squareshaped')
                f = float(0.70*screen_height)/float(height) # May2021
                
            elif width != height: # May2021
                print('rectangular shaped') # May2021
                
                if width != height: # May2021
                    if width > height: # May2021
                        print('width is higher than height') # May2021
                        f = float(0.70*screen_height)/float(width) # May2021
                    else: # May2021
            ...
            croppedimage_epi = croppedimage_epi[y1:y2, x1:x2] # May2021
            ...
            # Window of 100 µm on 100 µm
            croppedimage_unfocussed = croppedimage_unfocussed [y1:y2, x1:x2] # May2021
    ...
    #==========================================================================
        ...
        for mica_zstack in list_of_lists_mica:
            ...
            # Window of 100 µm on 100 µm
            img_mica_epi = img_mica_epi[y1:y2, x1:x2] # May2021
...
if live.get()==1 or live_mica.get()==1: 
    ...
    quit_button3 = Button(root_live,text = "Start live track recognition", command = close_live_window, cursor="hand2")
    quit_button3.pack()
    ...
    while cv2.waitKey(1) < 0:
        ...
        blob = cv2.dnn.blobFromImage(RGB_img, 1.0/255.0, (416,416), [0,0,0], True, crop=False)
        width = image.shape[1]
        ...
        if live.get()==1:     
            ...
            indices = cv2.dnn.NMSBoxes(boxes, confidences, 0.01, 0.6)
