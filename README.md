...
## Mac-OS users
You have to use the source code (.py) in a free Python-based IDE, for example Spyder or Pycharm. The source code can be opened using [Spyder IDE](https://www.spyder-ide.org/). Before you can use it, you need to install some Python modules:
